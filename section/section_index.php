<?php 
    ...
    $all_section = get_all_section($con, $errorMessage);
    $add_func = add_section($con);
    $delete_func = delete_section($con);
?>
                        ...
                        <tr>
                            ...
                            <td style="width: 160px; white-space: nowrap;">
                                <div class="d-flex justify-content-center" style="gap: 5px;">
                                    <a href="section_details.php?ID=<?php echo $row['id']; ?>" class="btn btn-primary btn-sm">View</a>
                ...
                <div class="modal-dialog" role="document">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="section_name">What Section?</label>
                            <input type="text" name="section_name" class="form-control">
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <input type="submit" class="btn btn-success" name="adding_section" value="ADD">
                    </div>
                    </div>
                </div>
                </div>
