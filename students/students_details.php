...
<div class="container-fluid mt-5">
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-12 col-md-9 col-lg-8 p-3">
            <h1><?php echo $student_byID['first_name']?>'s Details</h1>
            <div class="bg-dark">
                <div class="d-flex flex-nowrap">
                    <div class="card-body ml-2 text-white">
                        <p class="card-text">Full Name: <?php echo $student_byID['first_name'] . " ". $student_byID['last_name']; ?></p>
                    ...
                    <div class="mt-2 mb-2 mr-2">
                        <img src="../assets/uploads/<?php echo $student_byID['student_image']; ?>" class="img-fluid rounded-start" alt="No image" style="height: 300px; width: 300px; border:5px solid black;">
                    </div>
                </div>
            </div>
            <div class="mt-2">
